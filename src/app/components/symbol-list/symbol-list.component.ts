...
@Component({
	...
	standalone: true,
	imports: [CommonModule, LoadingSpinnerComponent, FormatNumberPipe, FormatNumberPipe, SymbolListPanelComponent, SymbolCalculatorSortComponent]
})
export class SymbolListComponent implements OnInit, OnDestroy {
	private subscriptionDownload: Subscription;
	private loadingService = inject(LoadingService);
	private initService = inject(InitService);
	private symbolListService = inject(SymbolListService);
